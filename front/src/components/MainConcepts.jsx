...
export default function MainConcepts() {
  return (
    <div className="px-3 flex flex-col lg:flex-row" style={{ gap:"3vw", marginTop:"15vh"}}>
        ...
        <div className="concepts w-[70%] lg:h-[40vh] xl:h-[35vh] self-end rounded-[3vw] shadow-xl p-5" style={{backgroundColor:"#ab9b82"}}>
            <p className="text-3xl lg:text-5xl">
                Vaše Potrebe
            </p>
            <p className="text-md lg:text-lg pt-3">
        ...
        <div className="concepts w-[70%] lg:h-[40vh] xl:h-[35vh] rounded-[3vw] shadow-xl p-5" style={{backgroundColor:"#222d40", color:"white"}}>
            <p className="text-3xl lg:text-5xl">
            Sigurnost
            </p>
            <p className="text-md lg:text-lg pt-3">
